...
export default function FawryConnectScreen() {
  const {
    credentials,
    isConnected,
    isConnecting,
...
const styles = StyleSheet.create({
  ...
  infoBannerRow: { flexDirection: "row", alignItems: "flex-start", gap: 10 },
  infoBannerText: {
    flex: 1,
    fontSize: 13,
    color: "#1d4ed8",
  ...
  savedInfoLabel: { fontSize: 13, color: "#64748b" },
  savedInfoValue: { fontSize: 13, color: "#1e293b" },
  formCard: {
    padding: 16,
    borderRadius: 16,
    marginBottom: 16,
  ...
  actionCard: { borderRadius: 16, marginBottom: 16, gap: 0 },
  actionButton: {
    marginBottom: 12,
    padding: 16,
  ...
  actionButtonSubtext: { fontSize: 12, color: "#64748b", marginTop: 2 },
});
